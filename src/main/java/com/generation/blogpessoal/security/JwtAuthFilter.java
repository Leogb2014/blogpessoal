...
public class JwtAuthFilter extends OncePerRequestFilter{
	...
	// injeção de dependencias da clase que conversa com o banco e valida se o usuario existe
	@Autowired
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		try {
			...
			//validação se existe um username que foi extraido do token e não temos regras configuradas de autorização
